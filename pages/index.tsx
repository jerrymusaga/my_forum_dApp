...
export default function Home() {
  const postManagerContract = "0x86498f56a6567105df334ccb3b4f7fe88dfed39d"; //postManager smart contract address
  ...
  async function getAllPosts() {
    ...
    if (ethereum) {
      ...
      //(1) call the getPosts function from the contract to get all Posts contract addresses4
